...
<li><span role="presentation" class="idg-iconPractices">{{{getCategoryIcon "practices"}}}</span> [Design for Uncertainty](/practices/DesignForUncertainty.html)</li>
<li><span role="presentation" class="idg-iconActivities">{{{getCategoryIcon "activities"}}}</span> [Cause and Effect](/activities/CauseAndEffect.html)</li></ul>
